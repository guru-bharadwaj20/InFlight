...
Deliberately does nothing that requires a service to be reachable, so the
pure-logic tests in test_units.py stay hermetic and runnable without Docker.
Anything needing Postgres or Redis lives in the fixtures of the tests that need
them.
"""
